...
var PullRefresh = function (_Component) {
    ...
    function PullRefresh() {
        ...
        return _possibleConstructorReturn(this, (PullRefresh.__proto__ || Object.getPrototypeOf(PullRefresh)).apply(this, arguments));
    }

    _createClass(PullRefresh, [{
        key: 'render',
        value: function render() {
            var distanceToRefresh = this.props.distanceToRefresh || 80;
